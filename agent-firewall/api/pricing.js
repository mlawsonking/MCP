...
const PRICING = {
  ...
  "description": "Prompt-injection, secret/PII, URL and IP checks for untrusted input.",
  "free": {
    "direct": {
      "url": "https://agent-firewall-seven.vercel.app",
      "auth": "none",
    ...
    "rapidapi_basic": {
      ...
      "url": "https://rapidapi.com/mlawsonking/api/agent-firewall"
    }
  },
  "paid_plans": [
    {
  ...
  "signup": "https://rapidapi.com/mlawsonking/api/agent-firewall",
  "mcp_install": {
    "command": "npx",
    "args": [
      "-y",
...
module.exports = (req, res) => {
  ...
  if (/[?&]pv=1(&|$)/.test(String(req.url || ''))) track(req, 'page_view', { product: 'agent-firewall', page: 'landing' });
