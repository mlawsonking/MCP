...
//
// package-guard-mcp — the package-guard tools, running locally.
//
...
const tools = registry.toolsFor('package-guard');
...
process.stderr.write(`package-guard-mcp ${pkg.version} running (${registered.length} tools)${offline ? ' [offline]' : ''}, rules ${rulesets.provenance()}.\n`);
