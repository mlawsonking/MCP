...
const PRICING = {
  "ok": true,
  "product": "Agent Web Tools",
  "description": "Web utilities for agents: read, unfurl, extract, feeds, DNS, SSL.",
  "free": {
    "direct": {
      "url": "https://agent-tools-api.vercel.app",
      "auth": "none",
    ...
    "rapidapi_basic": {
      ...
      "url": "https://rapidapi.com/mlawsonking/api/agent-web-tools"
    }
  },
  "paid_plans": [
    {
  ...
  "signup": "https://rapidapi.com/mlawsonking/api/agent-web-tools",
  "mcp_install": {
    "command": "npx",
    "args": [
      "-y",
...
module.exports = (req, res) => {
  ...
  if (/[?&]pv=1(&|$)/.test(String(req.url || ''))) track(req, 'page_view', { product: 'agent-tools', page: 'landing' });
