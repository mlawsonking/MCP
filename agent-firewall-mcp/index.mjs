...
//
// agent-firewall-mcp — the agent-firewall tools, running locally.
//
...
const tools = registry.toolsFor('agent-firewall');
...
process.stderr.write(`agent-firewall-mcp ${pkg.version} running (${registered.length} tools)${offline ? ' [offline]' : ''}, rules ${rulesets.provenance()}.\n`);
